...
const workstreamDefinitions: Workstream[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "M4-5", name: "Totals calculation", category: "Web UI", files: ["src/components/scope/totals-summary.tsx"] },
      { id: "M4-6", name: "AI scope integration", category: "Web UI", files: ["src/components/features/ai-scope-modal.tsx"] },
      { id: "M4-7", name: "Line item reordering", category: "Web UI", files: ["src/components/scope/line-items-table.tsx"] },
  ...
  },
  {
    ...
    color: "violet",
    tasks: [
      { id: "M5-1", name: "Photo upload API", category: "API", files: ["src/app/api/estimates/[id]/photos/route.ts"] },
      { id: "M5-2", name: "Photo gallery component", category: "Web UI", files: ["src/components/features/photos-tab.tsx"] },
      { id: "M5-3", name: "Photo capture (mobile)", category: "Web UI", files: ["src/components/photos/photo-capture.tsx"] },
      { id: "M5-4", name: "Photo linking", category: "Web UI", files: ["src/components/photos/photo-form.tsx"] },
